...
export const ScheduleEntries = [
  ...
  ScheduleEntry('09:00', 2, 'Games mania', 'Gamers all over the world - assemble! Pick whatever suits your gamer within and join the dedicated rooms (Kitchen Fussball, Yellow Table or Tineretului)', ['foyer']),
  ScheduleEntry('09:45', 2, 'Break', 'Have a break, have a Kit Kat.. Or join others "Afara la tigara"', ['foyer']),
  ScheduleEntry('10:00', 2, 'Paaaarty \\:D/', 'Bring on your best shoes and head on to the Dance floor to show off your best skills', ['foyer'])
